      ...
      <div class="container">
        <div class="row no-gutters slider-text js-fullheight align-items-end justify-content-start">
          <div class="col-md-9 ftco-animate pb-5">
          	<p class="breadcrumbs"><span class="mr-2"><a href="./ReservationMain.rez"">Home <i class="ion-ios-arrow-forward"></i></a></span> <span><a href="./InsuranceInfo.rez">사이트소개 <i class="ion-ios-arrow-forward"></i></a></span></p>
            <h1 class="mb-3 bread">보험안내</h1>
          </div>
        </div>
      </div>
    </section>
				...
				<div class="bd-example bd-example-tabs">
					...
					<div class="d-flex justify-content-center">
					  <ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
					    <li class="nav-item">
					      <a class="nav-link" id="pills-manufacturer-tab" data-toggle="pill" href="#pills-manufacturer" role="tab" aria-controls="pills-manufacturer" aria-expanded="true" style="font-size: 20px;">이용안내</a>
					    </li>
					    <li class="nav-item">
					      <a class="nav-link active" id="pills-review-tab" data-toggle="pill" href="#pills-review" role="tab" aria-controls="pills-review" aria-expanded="true" style="font-size: 20px;">보험안내</a>
					    </li>
					  </ul>
					</div>
