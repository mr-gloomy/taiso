...
//                text: '결제확인',
               ...
               if (result.isConfirmed) {           
                    //"예약" 버튼을 눌렀을 때 호출할 함수
                  location.href="./ReservationCancelCheck.rez?mem_id="+mDTO.mem_id ;
               } 
             }) 
    } 
                        ...
                        <div class="board_list_wrap">
                           <div class="board_list2">
                              ...
                              <div class="d-flex mb-3" style="display: flex; justify-content: center;">
                                  ...
                                  <input type = "button" class="btn btn-primary py-1 mr-1" onclick="location.href='./ReservationListAction.rez';" value = "예약 조회로 돌아가기">ㅤ
                                  <input type = "button" class="btn btn-primary py-2 mr-1" onclick="location.href='./ReservationCancelCheck.rez?mem_id=${mDTO.mem_id}&rez_uqNum=${rezDTO.rez_uqNum }&pay_uqNum=${payDTO.pay_uqNum }';" value = "예약 취소">
