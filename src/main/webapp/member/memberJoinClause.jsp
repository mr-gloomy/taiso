...
이 약관은 아이티윌부산협회(이하 "회사")가 운영하는 타이소 사이트(http://www.tamnao.com 및 m.tamnao.com, 이하 “타이소")에서 제공하는 인터넷 관련 서비스(이하 “서비스”라 한다)를 이용함에 있어 마켓과 이용자의 권리, 의무 및 책임사항을 규정함을 목적으로 합니다.
