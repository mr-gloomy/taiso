...
//		}
		...
		// DAO - 예약번호에 해당하는 예약정보를 모두 가져오는 메서드
		...
		// 예약정보를 request 영역에 저장
	      request.setAttribute("adminReservationList", adminTotalList.get(0));
	      request.setAttribute("adminPaymentList", adminTotalList.get(1));
		...
		forward.setPath("./views/adminReservationList.jsp");
